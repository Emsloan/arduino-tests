...
C:\Users\ivanFernandez\AppData\Local\Arduino15\packages\Microchip\hardware\megaavr\1.0.0\libraries\Flash\src\Flash.cpp:23:4: error: #error "You must also enable writing to flash from app in tools menu."
...
### Possible Fixes
1. Add an option to Tools menu to give the ability to enable writing to flash for the AVR DA-series boards.

2. Set a default writing to flash option within Boards.txt for the Microchip AVR128DA48 board.
