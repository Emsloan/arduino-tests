...
//Modified by pduncans 04/07/2022

// Changed to Serial3 for the DB48 is required
#define MySerial Serial3

#include <Wire.h>

//Modified slave address to work with the GY-521
...
void sendDataWire() {
  ...
  if (4 == Wire.requestFrom(slaveAddress, 4, 0x01)) {    // request from slave
